// deploy it as Molaris cloud function
...
async function bootServer() {
  ...
  if (gameState.get("state")) state = gameState.get("state");
}
...
async function getSVGString(tokenId) {
  // kovan
  let web3 = Moralis.web3ByChain("0x2a");
  // https://kovan.etherscan.io/address/0x07543dB60F19b9B48A69a7435B5648b46d4Bb58E
